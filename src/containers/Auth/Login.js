                ...
                <div className='login-container'>
                    <div className='login-content row'>
                        ...
                        <div className='col-12 form-group login-input'>
                            ...
                            <input type='text' className='form-control' placeholder='Enter your username' value={this.state.username} onChange={(event)=> {this.handelOnChangeUsername(event)}}></input>
                        </div>
                        <div className='col-12 form-group login-input '>
